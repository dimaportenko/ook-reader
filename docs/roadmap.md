...
**Next phase: [Phase 21 — Selection → prefilled chat (iOS)](milestones/06-ai-chat/README.md)**, not yet planned; see [Milestone 6](milestones/06-ai-chat/README.md). [Phase 20](milestones/06-ai-chat/04-selection/phase-20-selection-chat.md) closed 2026-09-24 (`2f01fc9`, 190 tests): the toolbar chat icon drafts the selected passage with the book's title, author and chapter, sends it to Gemini, and opens a swipe-to-close drawer. [Phase 19](milestones/06-ai-chat/03-chat-panel/phase-19-chat-panel.md) closed 2026-09-22 (`0302f0e`, 175 tests): a chat drawer over the reader sends the conversation to Gemini and shows the answer, on desktop, the iOS simulator and a real iPhone. [Phase 18](milestones/06-ai-chat/02-key-storage/phase-18-key-storage.md) closed 2026-09-20 (`3439746`, 167 tests): the Gemini key lives in the OS keychain behind a `SecretStore` trait, the settings row saves/forgets it and picks the model, and a fresh launch has a provider ready in context. [Phase 17](milestones/06-ai-chat/01-provider/phase-17-provider-boundary.md) closed 2026-09-13 (`2b9e826`, 149 tests).
