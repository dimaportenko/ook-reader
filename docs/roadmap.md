...
**Current phase: [Phase 17 — Provider boundary + Gemini](milestones/06-ai-chat/01-provider/phase-17-provider-boundary.md)** (opened 2026-09-11, Step 1 done — `aa29912`; Step 2 in progress).
