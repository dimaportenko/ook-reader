...
**Current phase: [Phase 17 — Provider boundary + Gemini](milestones/06-ai-chat/01-provider/phase-17-provider-boundary.md)** (opened 2026-09-11, Steps 1–2 done, latest `e74b4ed`).
