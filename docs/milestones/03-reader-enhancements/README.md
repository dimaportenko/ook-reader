...
**Status:** 🚧 in progress — Milestone 2 shipped, so this is now the current focus, starting
with Themes & Typography.

## Candidate features (to prioritize later)

| Feature | Idea | Difficulty | Status |
|---|---|---|---|
| [Themes & typography](04-themes-typography/README.md) | Font, size, spacing, light/dark/sepia via injected CSS variables | Easy (optionally vendor [ReadiumCSS](https://github.com/readium/readium-css)) | 🚧 **in progress** ([ADR-0003](../../adr/0003-reader-controlled-theming-injected-layer.md)) |
