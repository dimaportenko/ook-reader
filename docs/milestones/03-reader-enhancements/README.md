...
Typography (Phase 4) and ToC & Navigation (Phase 8) are both **done**, and **no phase is
currently open**: the next feature off the candidate list below has not been chosen yet.
